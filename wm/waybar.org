...
** Layout
   #+BEGIN_SRC js
     ...
     "modules-center": ["mpd"],
     "modules-right": ["tray", "bluetooth", "clock", "network", "backlight", "pulseaudio", "memory", "cpu", "battery"],
   #+END_SRC
** Sway workspaces
   #+BEGIN_SRC js
     "sway/workspaces": {
...
** Modules
   #+BEGIN_SRC css
     ...
     #mode, #tray, #bluetooth, #clock, #network, #backlight, #pulseaudio, #memory, #cpu {
         padding: 0 10px;
         margin: 0 5px;
         border-bottom: 3px solid #<<base00>>;
     }
