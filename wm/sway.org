...
** Pickers
   ...
   #+BEGIN_SRC conf
         bindsym $mod+f2 exec passpick
         bindsym $mod+Shift+f2 exec passpick --login
   #+END_SRC

   browse clipboard history
   #+BEGIN_SRC conf
         bindsym $mod+f3 exec cliphist list | fuzzel -d | cliphist decode | wl-copy
   #+END_SRC
** Moving around
...
** Workspaces
   ...
   #+BEGIN_SRC conf
         ...
         bindsym $mod+Shift+space move container to output right
   #+END_SRC
