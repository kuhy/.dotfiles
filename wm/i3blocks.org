...
align=center
markup=pango
SCRIPT_DIR=/home/kuhy/.config/i3blocks
#+END_SRC
...
** Volume icon
:PROPERTIES:
:header-args: :tangle ~/.config/i3blocks/vol_ic :comments both :shebang "#!/bin/env bash" :mkdirp yes :noweb tangle
:END:
#+BEGIN_SRC sh
