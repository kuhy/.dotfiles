...
* Profiles
  :PROPERTIES:
  :header-args: :tangle ~/.var/app/org.mozilla.firefox/.mozilla/firefox/profiles.ini :comments both :mkdirp yes :noweb tangle
  :END:
...
* General
  :PROPERTIES:
  :header-args: :tangle ~/.var/app/org.mozilla.firefox/.mozilla/firefox/default/user-overrides.js :comments both :mkdirp yes :noweb tangle
  :END:
...
** User interface
   :PROPERTIES:
   :header-args: :tangle ~/.var/app/org.mozilla.firefox/.mozilla/firefox/default/chrome/userChrome.css :comments both :mkdirp yes :noweb tangle
   :END:
...
** Web pages
   :PROPERTIES:
   :header-args: :tangle ~/.var/app/org.mozilla.firefox/.mozilla/firefox/default/chrome/userContent.css :comments both :mkdirp yes :noweb tangle
   :END:
