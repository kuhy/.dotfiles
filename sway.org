...
:END:
Colors are included from [[file:colors.org][colors.org]].
#+INCLUDE: "colors.org"
...
#+BEGIN_SRC conf
set $web_browser qutebrowser
#+END_SRC

Your preferred file browser
#+BEGIN_SRC conf
set $file_browser termite -e ranger
#+END_SRC
...
# client.urgent         <<color2>> <<color2>> #ffffff #900000   <<color2>>
...
#       colorclass         border  background text
        focused_workspace  #d7907b #d7907b #ffffff
#        active_workspace   #d7907b #d7907b #ffffff
